...
ACCESS_KEY = "yfqMW8gf8u+M5pOW33Q5gtRTFBJQXStVK4K2rlCVVzxlrRG21Sh7MVj06uExoL86Npb7HWWgxYUe+ASthUr6/g=="  # Replace with your real key or use st.secrets
...
if not ride_df.empty:
    ...
    if "ride_duration_min" in ride_df.columns:
        dur_fig = px.histogram(ride_df.dropna(subset=["ride_duration_min"]),
                               x="ride_duration_min", nbins=30, title="Ride Duration (min)")
